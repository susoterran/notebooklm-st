...
3. **채널** 화면은 **새 영상 확인 · 채널 등록 · 등록된 채널** 세 탭으로 갈립니다. 등록 탭에서 채널 URL 을 등록해 두고, 확인 탭에서 대상 채널과 기준일을 고른 뒤 **새 영상 확인**을 누르면 아직 요약하지 않은 영상만 모입니다. 목록에서 바로 요약을 시작합니다. (고른 기준일은 그 채널에 저장되며, 채널 피드는 최신 15건까지 줍니다)
