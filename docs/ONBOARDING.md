...
> **R2 이후로 갱신하지 않은 스냅숏이다.** R3·R4 의 변경(답변 편집과 마크다운 내려받기 삭제, Outline 저장)은 반영되어 있지 않다.
...
**README 가 없다.** 도구의 정체를 알려 주는 문서는 한국어 기획서 [`docs/requests/2026-08-28-youtube-qa.md`](requests/2026-08-28-youtube-qa.md) 이며, 코드를 열기 전 이 문서를 먼저 읽어야 한다. (`CLAUDE.md` 는 빈 파일이다.)
...
1. `docs/requests/2026-08-28-youtube-qa.md` 를 읽는다 (10분)
